...
$Ficha= new Ficha($_GET['idEliminar']);
$ficha = new Ficha($_GET['idEliminar']);
$ficha = $ficha -> eliminar();
$Ficha2 = new Ficha();
$Fichas = $Ficha2->consultarTodos();
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($Fichas as $f){
                                                ...
                                                echo "\n<a href='index.php?pid=" . base64_encode("presentacion/Administrador/consultarFichas.php") . "&idEliminar=" . $f -> getId() . "'>";
