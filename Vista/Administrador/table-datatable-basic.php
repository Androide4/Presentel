                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($Alquileres as $a){
                                                ...
                                                echo "<td>" .$a -> getCarro() . "</td>";
                                                echo "<td>" .$a -> getCliente() . "</td>";
                                                echo "<td>". $a -> getFecha() . "</td>";
                                                echo "<td>". $a -> getHoraInicio() . "</td>";
                                                echo "<td>". $a -> getHoraFinal() . "</td>";
                                                echo "<td>"."$ ". $a -> getPrecio() . "</td>";
                                                echo "<td>";
                                                echo "<a href='index.php?pid=" . base64_encode("presentacion/Cliente/generarFactura.php") . "&idAlquiler=" . $a -> getId() . "'>";
                                                echo "<div  class='fas fa-file-pdf' data-toggle='tooltip' data-placement='left' title='Generar PDF'></div>";
                                                echo "</td>";
                                                echo "</tr>";
                                            }
                                            ?>
